...
category: article
date: 2026-2-22
excerpt: '**Sometimes, the most fun problems to work on are the** ones easiest to visualize. We will go through 2 proofs of a deceptively simple statement conjectured by James Joseph Sylvester in 1893: one of them is a surprisingly short one by Kelly (1986) and the other is a more conceptually dense one by Melchior (1941).'
