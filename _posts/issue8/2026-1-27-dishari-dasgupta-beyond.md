...
author-bio: '**Dishari Dasgupta**, currently a PMRF scholar at the Dog Lab, works under the joint supervision of Prof. Anindita Bhadra and Dr. Manabi Paul. Her research focuses on the urban adaptation of free-ranging langurs and their interaction dynamics with free-ranging dogs and humans.'
authorImage: Dishari.JPG
authors:
- Dishari Dasgupta
category: article
date: 2026-1-27
excerpt: "Dishari traces how Jane Goodall, a young woman with no formal scientific training, walked into Gombe with a notebook and binoculars and ended up overturning one of humanity\u2019s most cherished assumptions \u2014 that tool-making, complex social life, and culture belonged to us alone."
hero-image: dishari.svg
issue: 8
...
{% include figure.html image='dishari2.jpg' caption='Jane Goodall with David Graybeard. In Gombe, the first chimp to lose their fear of Jane was Greybeard. This have Jane the opportunity to study the complex world of chimpanzee life. [National Geographic / Jane Goodall Institute]' width=800 %}
...
{% include figure.html image='dishari3.jpg' caption='The Jane Goodall Institute is a global organization founded by Dr. Jane Goodall in 1977. It works in 6 African countries and supports the rehabilitation of chimpanzees, alongside conservation projects. [Jane Goodall Institute]' width=800 %}
