...
excerpt: "Sharanya Chatterjee (Editor, InScight)"
category: meta
---
...
{% include figure.html image="comic.svg" caption="Arya Mhatre of IISER Kolkata depicts the pathbreaking achievements of Aditi Pant and Sudipta Sengupta as they became the first Indian women to participate in the Antarctic program. [Read her comic to find out more](/issue6/comic-antarctica/)." suppressPrefix=true width=500 %}
...
{% include figure.html image="iGEM.svg" caption="Sharanya Chatterjee and Madhura Theng from _InScight_ cover the story  of IISER Kolkata’s iGEM 2025 team has engineered ReSET, a probiotic-based theranostic system that senses tumor-specific cues. Learn more in [this article](/issue6/sharanya-2025/)." suppressPrefix=true width=500 %}
