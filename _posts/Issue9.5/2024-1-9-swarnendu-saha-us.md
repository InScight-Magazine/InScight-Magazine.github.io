...
hero-image: trends.svg
issue: '9.5'
permalink: /issue9.5/swarnendu-saha-us/
refs-file: trends
reviewed-by:
- Shibaraj Sahu
- Abhirup Mukherjee
...
{% include figure.html image='Wasteful-Spending_asset3.png' caption='A survey conducted in the US among various age group and regions of residence have shown that most Americans overspend and overpay for leisure and luxury items when other cheaper items serve the same purpose. They also overspend in order tp upgrade to the "latest and greatest" product. See [7].' width=800 %}
...
Avoiding trends, though challenging, requires a nuanced understanding of how our biology, psychology, and evolutionary history shape our behaviour. Biochemically, trends stimulate dopamine release, the brain’s reward signal, making conformity feel gratifying. Physiologically, this {% include figure.html image='brainParts.svg' caption='Schematic structure of the human brain. The part of the brain behind the forehead, called the prefrontal cortex, is one of the last parts to mature. This area is responsible for skills like planning, prioritising, and making good decisions.' width=800 %}
