...
hero-image: SN.svg
issue: '9.5'
permalink: /issue9.5/shyama-narendranath/
title: In Conversation with ISRO Scientist Shyama Narendranath
---
...
SS: Oh, have you been trained in Kathakali, or was it another form of classical dance? {% include figure.html image='iisc.jpeg' caption='SN completed her PhD from the Indian Institute of Science, Bangalore.' width=800 %}

{% include figure.html image='dance.jpg' caption='SN performing the Indu Sairisiri at Udupi krishna temple in Karnataka.' width=800 %}
...
{% include figure.html image='SN3.jpg' caption='PSLV C11 carrying Chandrayaan-1. SN was involved in developing the Chandrayaan-1 X-ray spectrometer, in collaboration with the Rutherford Appleton Laboratory in the UK.' width=800 %}
...
{% include figure.html image='SN4.jpg' caption='Aerial view of Rutherford Appleton Laboratory, where SN worked towards Chandrayaan-1.' width=800 %}
...
{% include figure.html image='SARA.jpg' caption='European Lunar X-Ray Camera, employed on Chandrayaan 1. SN was the Instrument Operations Scientist at ISRO at that time.' width=800 %}
