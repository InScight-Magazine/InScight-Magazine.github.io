...
{% include figure.html image='Koshliakov.jpg' caption='Nikolai Sergeevich Koshliakov (Picture courtesy: V. N. Koshlyakov, O. A. Ladyzhenskaya and D. R. Merkin and M. M. Smirnov, Vestnik Leningrad Univ. Mat. Mekh. Astronom. (1991) No. 4, 81–83.)' width=700 %}
...
{% include figure.html image='stpetersburg.jpg' caption='Koshliakov graduated from the Faculty of Physics and Mathematics of the University of St. Petersburg in 1914.' width=700 %}
...
$$(n = 1)^{\infty}\left( n - \frac{1}{2} \right)^{- s} = \left( 2^{s} - 1 \right)\zeta(s).$$
...
{% include figure.html image='rajat.jpg' caption='**Rajat Gupta** was then a PhD student under Atul Dixit when they studied Koshliakov"s second manuscript in more detail and even managed to extend his theory.' width=700 %}
 ---
