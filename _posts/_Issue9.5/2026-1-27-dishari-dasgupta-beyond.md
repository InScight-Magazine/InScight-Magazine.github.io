...
issue: 8
permalink: /issue9.5/dishari-dasgupta-beyond/
refs-file: dishari
reviewed-by:
- Ishita Bardhan
...
Her story also reminds us that science is a method that can be used by people, who were not formally trained in their ‘formative’ years, to go on to do great work in future, given the right mentorship, generous funding agency, great visual storytelling, and timing. {% include figure.html image='dishari3.jpg' caption='The Jane Goodall Institute is a global organization founded by Dr. Jane Goodall in 1977. It works in 6 African countries and supports the rehabilitation of chimpanzees, alongside conservation projects. [Jane Goodall Institute]' width=800 %}
