---
author-affiliation:
- Department of Biotechnology, St. Xavier's College
author-bio: '**Professor Dhara** is a clinical and environmental microbiologist with specializations in studying host-pathogen interactions, nanobiotechnology, and transdisciplinary research. He is a distinguished faculty of Department of Microbiology, Saveetha Medical College and Hospital, Chennai, India.'
authorImage: dhara.jpg
authors:
- Subham Sarkar
category: interview
date: '2025-12-26'
excerpt: '**Prof. Bikram Dhara discusses the evolving mindset of** Indian science students, shaped by career pressures and global aspirations. He critiques exam-centric systems, declining interest in basic science, and weak mentorship, while advocating interdisciplinary learning, ethical research, and resilience, framing scientific pursuit as a lifelong commitment rooted in curiosity and social responsibility.'
hero-image: dhara.svg
issue: 8
permalink: /issue8/prof-bikram-dhara/
...
{% include figure.html image='dhara2.jpeg' caption='**Prof. Bikram Dhara** being felicitated at Scottish Church College, Kolkata, India.' width=800 %}
...
{% include figure.html image='dhara4.jpeg' caption='**Prof. Bikram Dhara** is a trained herpetologist.' width=800 %}
...
{% include figure.html image='dhara7.jpeg' caption='**Prof. Bikram Dhara** in conversation with his mentor, Dr. Arup Kumar Mitra, at Bhagalpur University, India.' width=800 %}
...
{% include figure.html image='dhara5.jpeg' caption='**Prof. Bikram Dhara** at Forest Research Institute, Dehradun, India.' width=800 %}
...
{% include figure.html image='dhara6.jpeg' caption='**Prof. Bikram Dhara** addressing at a conference at Khulna University, Bangladesh.' width=800 %}
