...
category: article
date: '2025-12-22'
excerpt: '**Wilson disease occurs due to toxic copper accumulation** and oxidative stress, yet current therapies only chelate excess copper but do not reduce oxidative stress. This study repurposes melatonin as a dual-action molecule that both chelates copper and modulates redox imbalance.'
...
{% include figure.html image='pandey1.svg' caption='Healthy individual liver Vs Cirrhotic liver in Wilson Disease' width=800 %}
...
{% include figure.html image='Pandey2.jpg' caption='Eye discoloration in Wilson Disease Patient. [Source: Wilson Disease Association]' width=800 %}

 {% include figure.html image='pandey3.svg' caption='Cell Viability assay showing cells lacking ATP7B are more sensitive to copper' width=800 %}
...
{% include figure.html image='pandey4.jpg' caption='Due to excess copper accumulation, there is more oxidative stress in ATP7B$$^\{-/-\}$$ HepG2 cells.' width=800 %}
...
{% include figure.html image='pandey5.jpg' caption='Cell Viability has improved after melatonin treatment.' width=800 %}

 {% include figure.html image='pandey6.jpg' caption='Melatonin markedly attenuates copper-induced oxidative stress, demonstrating superior protective efficacy compared to D-pen and NAC.' width=800 %}
...
{% include figure.html image='pandey7.png' caption='Melatonin exhibits the strongest suppression of Nrf2 nuclear localization, outperforming D-Pen and NAC.' width=800 %}
...
{% include figure.html image='pandey11.png' caption='Representative Spinning-disk confocal show increased CellROX fluorescence with Cu (500 µM), which is reduced by melatonin co-treatment.' width=800 %}

{% include figure.html image='pandey13.jpg' caption='Melatonin helps _C. elegans_ to alleviate free copper.' width=800 %}
...
{% include figure.html image='pandey14.jpg' caption='Melatonin treatment rescues cua-1 from oxidative stress.' width=800 %}
...
{% include figure.html image='pandey15.jpg' caption='MNC show improved serum stability, ensuring sustained melatonin availability.' width=800 %}

 {% include figure.html image='pandey17.png' caption='MNC is more efficient than free melatonin in reducing oxidative stress.' width=800 %}

 {% include figure.html image='pandey16.png' caption='MNCs exhibit redox-triggered release in response to GSH.' width=800 %}
