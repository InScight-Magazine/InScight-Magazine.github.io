...
{% include figure.html image='images/satavisha1.png' caption='Two enantiomers of a chiral compound are mirror images of each other, that cannot be superimposed' width=800 %}

{% include figure.html image='images/satavisha2.png' caption='(R)-(+)-asparagine has sweet taste whereas <br>
 (S)‑(−)-asparagine is bitter' width=800 %}
...
{% include figure.html image='images/satavisha3.jpg' caption='Two enantiomers of a drug often interact differently with receptors' width=800 %}
...
{% include figure.html image='images/satavisha4.png' caption='Dopamine is formed from (S)-(-)-DOPA' width=800 %}
...
{% include figure.html image='images/satavisha5.png' caption='A wide range of enantioselective transformations has been successfully accomplished using <br>
...
{% include figure.html image='images/satavisha6.png' caption='The concept of **a)** cooperative catalysis; **b)** synergistic catalysis and **c)** relay catalysis' width=800 %}
...
{% include figure.html image='images/satavisha7.png' caption='Advanced molecular transformations by “transition metal/chiral Brønsted acid” hybrid catalytic system' width=800 %}
