...
{% include figure.html image='sridip.svg' caption='What if we do not have to look for solutions to equations of motion abiding physical laws, rather the solutions are forced upon us, leaving almost no room of choice? This article explores how simple consistency rules, pushed to their limits through a mathematical machinery called conformal bootstra……  ' width=400 %}
...
{% include figure.html image='sangita.png' caption='Growing up as a girl in a rural village, I never imagined I would end up where I am today. Now, as an Assistant Professor of Mathematics at IISER Berhampur, I look back and realise how simple the recipe for success truly is. My journey taught me that you can overcome almost any obstacle if you stay ……  ' width=400 %}
