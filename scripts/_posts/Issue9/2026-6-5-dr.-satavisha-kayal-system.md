...
{% include figure.html image='satavisha1.png' caption='Two enantiomers of a chiral compound are mirror images of each other, that cannot be superimposed' width=800 %}

{% include figure.html image='satavisha2.png' caption='(R)-(+)-asparagine has sweet taste whereas <br>
